...
pub fn get_pipeline<'a>(
    ...
    let key = PipelineKey {
        shader_id: ShaderId::ForwardUnlit as u64,
    ...
    cache.get_or_create(key, frame_index, || {
        device.create_render_pipeline(&wgpu::RenderPipelineDescriptor {
            label: Some("Forward Unlit Pipeline"),
            layout: Some(&library.forward_unlit_pipeline_layout),
            vertex: wgpu::VertexState {
                module: &library.forward_unlit_shader,
