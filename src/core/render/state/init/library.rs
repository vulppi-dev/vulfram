use super::super::{RenderState, light::LightDrawParams};
...
impl RenderState {
    pub(crate) fn init_layouts(&self, device: &wgpu::Device) -> Layouts {
                        ...
                        min_binding_size:
                            Some(
                                std::num::NonZeroU64::new(
                                    std::mem::size_of::<crate::core::resources::CameraComponent>() as u64
                                )
                                .unwrap(),
                            ),
                    },
        ...
        let layout_object = device.create_bind_group_layout(&wgpu::BindGroupLayoutDescriptor {
            ...
            entries: &[wgpu::BindGroupLayoutEntry {
                ...
                ty: wgpu::BindingType::Buffer {
                    ...
                    min_binding_size: Some(
                        std::num::NonZeroU64::new(
                            std::mem::size_of::<crate::core::resources::ModelComponent>() as u64
                        )
                        .unwrap(),
                    ),
                },
                ...
                entries: &[
                    ...
                    wgpu::BindGroupLayoutEntry {
                        ...
                        ty: wgpu::BindingType::Buffer {
                            ...
                            min_binding_size: Some(
                                std::num::NonZeroU64::new(
                                    std::mem::size_of::<crate::core::resources::MaterialStandardParams>() as u64,
                                )
                                .unwrap(),
                            ),
                        },
                ...
                entries: &[
                    ...
                    wgpu::BindGroupLayoutEntry {
                        ...
                        ty: wgpu::BindingType::Buffer {
                            ...
                            min_binding_size: Some(
                                std::num::NonZeroU64::new(
                                    std::mem::size_of::<crate::core::resources::MaterialPbrParams>() as u64,
                                )
                                .unwrap(),
                            ),
                        },
        ...
        Layouts {
            ...
            object_standard: layout_object_standard,
            object_pbr: layout_object_pbr,
            target: layout_target,
            light_cull: layout_light_cull,
        }
    }
}
