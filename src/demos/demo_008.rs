...
use crate::core::resources::{
    ...
    MaterialSampler, PrimitiveShape, StandardOptions, ViewAnchor, ViewPosition, ViewSize, ViewValue,
};
...
pub fn run(window_id: u32) -> bool {
    ...
    let setup_cmds = vec![
        ...
        EngineCmd::CmdCameraCreate(CmdCameraCreateArgs {
            camera_id: camera_overlay_id,
            label: Some("Demo8 Overlay Camera".into()),
            transform: Mat4::look_at_rh(Vec3::new(-4.0, 5.0, 6.0), Vec3::ZERO, Vec3::Y).inverse(),
            kind: CameraKind::Perspective,
            flags: 0,
            near_far: Vec2::new(0.1, 100.0),
            layer_mask: 0xFFFFFFFF,
            ...
            view_position: Some(ViewPosition {
                anchor: ViewAnchor {
                    x: ViewValue::Relative(0.68),
                    y: ViewValue::Relative(0.02),
                },
                size: ViewSize {
                    width: ViewValue::Relative(0.30),
                    height: ViewValue::Relative(0.30),
                },
            }),
            ortho_scale: 10.0,
        }),
        EngineCmd::CmdCameraCreate(CmdCameraCreateArgs {
            ...
            transform: Mat4::look_at_rh(Vec3::new(4.5, 3.0, 6.0), Vec3::ZERO, Vec3::Y).inverse(),
            kind: CameraKind::Perspective,
            flags: 0,
            near_far: Vec2::new(0.1, 100.0),
            layer_mask: 0xFFFFFFFF,
        ...
        EngineCmd::CmdMaterialCreate(CmdMaterialCreateArgs {
            ...
            label: Some("Demo8 UI Plane".into()),
            kind: MaterialKind::Standard,
            options: Some(MaterialOptions::Standard(StandardOptions {
        ...
        EngineCmd::CmdModelCreate(CmdModelCreateArgs {
            ...
            transform: Mat4::from_translation(Vec3::new(0.0, 1.0, 3.0))
                ...
                * Mat4::from_scale(Vec3::splat(2.8)),
            layer_mask: 0xFFFFFFFF,
            cast_shadow: false,
    ...
    run_loop_with_events(
        ...
        move |total_ms, _delta_ms| {
            ...
            let overlay_angle = total_ms as f32 * 0.001;
                ...
                EngineCmd::CmdModelUpdate(crate::core::resources::CmdModelUpdateArgs {
                    ...
                    transform: Some(
                        Mat4::from_translation(Vec3::new(2.0, 0.75, -1.5))
                            * Mat4::from_rotation_y(-overlay_angle)
                            * Mat4::from_rotation_x(overlay_angle * 0.5)
                            * Mat4::from_scale(Vec3::splat(1.2)),
                    ),
                    layer_mask: None,
                    cast_shadow: None,
...
fn build_ui_ops_screen(camera_target_id: u32, camera_id: u32) -> Vec<UiOp> {
    ...
    ops.push(UiOp::Add(UiOpAdd {
        ...
        variant: None,
        style: None,
        props: Some([("value".to_string(), UiValue::String("Demo 008 - UI + Render".into()))].into_iter().collect()),
        listeners: None,
    }));
    ...
    ops.push(UiOp::Add(UiOpAdd {
        ...
        variant: None,
        style: Some([
            ("width".to_string(), UiValue::Float(320.0)),
            ("height".to_string(), UiValue::Float(220.0)),
        ]
        .into_iter()
        .collect()),
        props: Some([
            ("textureId".to_string(), UiValue::Int(camera_target_id as i64)),
    ...
    ops.push(UiOp::Add(UiOpAdd {
        ...
        .into_iter()
        .collect()),
        props: Some([("value".to_string(), UiValue::String("UI Animations".into()))].into_iter().collect()),
        listeners: None,
    }));
    ...
    ops.push(UiOp::Add(UiOpAdd {
        ...
        variant: None,
        style: None,
        props: Some([("value".to_string(), UiValue::String("Frame: 0".into()))].into_iter().collect()),
        listeners: None,
    }));
...
fn build_ui_ops_panel() -> Vec<UiOp> {
    ...
    ops.push(UiOp::Add(UiOpAdd {
        ...
        variant: None,
        style: None,
        props: Some([("value".to_string(), UiValue::String("Panel in Render".into()))].into_iter().collect()),
        listeners: None,
    }));
